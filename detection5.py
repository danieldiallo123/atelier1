...
if uploaded_video is not None:
    ...
    while cap.isOpened():
        ...
        # Ajout des infos à l'écran
        cv2.putText(frame, f"FPS: {fps:.2f}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2)
        cv2.putText(frame, f"Personnes visibles (frame): {persons_in_frame}", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 165, 0), 2)
        cv2.putText(frame, f"Personnes uniques détectées: {len(known_descriptors)}", (10, 110),
