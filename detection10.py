...
mode = st.radio("Choisir la source vidéo :", ("Charger vidéo", "Webcam"))

video_path = None
if mode == "Charger vidéo":
    uploaded_video = st.file_uploader("Charger vidéo", type=["mp4", "avi"])
...
if video_path is not None:
    ...
    st.info("Sélectionner une source vidéo ci-dessus.")
